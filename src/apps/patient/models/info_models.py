...
class Category(models.Model):
    CATEGORY_STATUS_CHOICES = (
        ('1', 'Патологическое влечение имеет ситуационное'),
        ('2', 'Спонтанное течение с борьбой'),
        ('3', 'Без борьбы мотивов'),
        ('4', 'Ситуационный контроль утрачен'),
        ('5', 'Не утрачен'),
        ('6', 'Палимпсесты есть'),
        ('7', 'Палимпсесты есть нет'),
        ('8', 'Тотальная амнезия есть'),
        ('9', 'Тотальная амнезия есть нет'),
    )
